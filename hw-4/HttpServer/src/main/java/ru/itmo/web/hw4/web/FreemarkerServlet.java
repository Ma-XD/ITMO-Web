...
import ru.itmo.web.hw4.util.UriUtil;
...
public class FreemarkerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            template = freemarkerConfiguration.getTemplate("/misc/not_found.ftlh");
        }
    ...
    private Map<String, Object> getData(HttpServletRequest request, String uri) {
        ...
        data.put("current_menu_page", UriUtil.getCurrentMenuPage(uri));
        return data;
    }

    private boolean isNumber(Object object) {
        try {
            long res = Long.parseLong(object.toString());
            return res >= 0;
